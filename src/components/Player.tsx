...
export default function Player() {
  ...
  const $currentTracks = useStore(currentTracks);
        ...
        <div className="flex gap-6 items-center text-black">
          <button
            onClick={() => {
              ...
              if (index - 1 >= 0) {
                currentTrackId.set($currentTracks[index - 1].id);
              }
            }}
          >
            <svg
          ...
          <button onClick={() => isPlaying.set(!$isPlaying)}>
          ...
          <button
            onClick={() => {
              ...
              const lastIndex = $currentTracks.length - 1;
